...
import { ServerAdapter, ServerAdapterBaseObject, ServerAdapterOptions, ServerAdapterRequestHandler, useCORS } from '@whatwg-node/server';
...
export declare class YogaServer<TServerContext extends Record<string, any>, TUserContext extends Record<string, any>> implements ServerAdapterBaseObject<TServerContext> {
    ...
    getResultForParams({ params, request, }: {
        ...
        request: Request;
    }, context: TServerContext): Promise<ExecutionResult<import("graphql/jsutils/ObjMap.js").ObjMap<unknown>, import("graphql/jsutils/ObjMap.js").ObjMap<unknown>> | AsyncIterable<ExecutionResult<import("graphql/jsutils/ObjMap.js").ObjMap<unknown>, import("graphql/jsutils/ObjMap.js").ObjMap<unknown>>> | undefined>;
